...
export default function Pricing() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${
      ...
      {/* Dynamic Background Elements - Made more visible */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        {/* Floating Geometric Shapes - Made more visible */}
        <motion.div
          className={`absolute w-20 h-20 ${theme === 'dark' ? 'bg-gradient-to-r from-orange-500 to-red-500' : 'bg-gradient-to-r from-orange-400 to-red-400'} rounded-lg`}
          style={{ 
            top: '20%', 
            left: '10%',
        ...
        <motion.div
          className={`absolute w-16 h-16 border-4 ${theme === 'dark' ? 'border-orange-500' : 'border-orange-400'} rounded-full`}
          style={{ 
            top: '60%', 
            right: '15%',
        ...
        <motion.div
          className={`absolute w-12 h-12 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full`}
          style={{ 
            top: '30%', 
            right: '20%',
        ...
        <motion.div
          className={`absolute w-8 h-8 bg-gradient-to-r from-pink-400 to-red-500 rounded-lg`}
          style={{ 
            bottom: '25%', 
            left: '15%',
