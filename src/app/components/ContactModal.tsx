              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-8">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-between px-6 py-4 border-2 border-[#ff5500] text-[#ff5500] rounded-full transition-all duration-300 font-semibold text-base group ${
                  ...
                  >
                    ...
                    <svg className="w-5 h-5 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
