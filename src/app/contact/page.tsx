            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-xl shadow-lg">
                    📧
                  </div>
                  <div className="flex-1">
                    ...
                    <a href="mailto:hello@siteandsight.com" className="text-blue-500 font-semibold hover:text-blue-600 transition-colors">
                      hello@siteandsight.com
                    </a>
                    ...
                    <a href="mailto:business@siteandsight.com" className="text-blue-500 font-semibold hover:text-blue-600 transition-colors">
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="tel:+11234567890" className="text-green-500 font-semibold hover:text-green-600 transition-colors">
                      +1 (123) 456-7890
                    </a>
                  </div>
                </div>
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white text-xl shadow-lg">
                    📍
                  </div>
                  <div className="flex-1">
                    <h3 className={`text-xl font-bold mb-2 ${
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white text-xl shadow-lg">
                      🌐
                    </div>
                    <div className="flex-1">
                  ...
                  <div className="flex gap-4">
                    <a href="#" className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                      theme === 'dark' ? 'bg-gray-700 text-gray-300 hover:bg-blue-600 hover:text-white' : 'bg-gray-100 text-gray-600 hover:bg-blue-500 hover:text-white'
                    }`}>
                    ...
                    <a href="#" className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                      theme === 'dark' ? 'bg-gray-700 text-gray-300 hover:bg-pink-600 hover:text-white' : 'bg-gray-100 text-gray-600 hover:bg-pink-500 hover:text-white'
                    }`}>
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                      theme === 'dark' ? 'bg-gray-700 text-gray-300 hover:bg-blue-400 hover:text-white' : 'bg-gray-100 text-gray-600 hover:bg-blue-400 hover:text-white'
                    }`}>
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                      theme === 'dark' ? 'bg-gray-700 text-gray-300 hover:bg-red-600 hover:text-white' : 'bg-gray-100 text-gray-600 hover:bg-red-500 hover:text-white'
                    }`}>
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <motion.h2 
              ...
              transition={{ duration: 0.6 }}
            >
              Common <span className="text-[#ff5500]">questions</span>
            </motion.h2>
            ...
            {[
              {
                ...
                answer: "We typically begin new projects within 1-2 weeks, depending on our current workload. For urgent projects, we can often accommodate faster start times.",
                icon: "⚡"
              },
              {
                question: "Do you offer website maintenance?",
                answer: "Yes! We provide ongoing maintenance and support packages to keep your website updated, secure, and performing optimally.",
                icon: "🛠️"
              },
              {
                question: "What's your design process like?",
                answer: "Our process involves discovery, strategy development, design creation, client feedback, and final implementation. We keep you involved every step of the way.",
                icon: "🎨"
              },
              {
                question: "Can you help with SEO and marketing?",
                answer: "Absolutely! We offer comprehensive SEO services, content marketing, social media management, and digital advertising to grow your online presence.",
                icon: "📈"
              },
              {
                question: "Do you work with international clients?",
                answer: "Yes, we work with clients worldwide. Our team is experienced in managing projects across different time zones and cultural contexts.",
                icon: "🌍"
              }
            ].map((faq, index) => (
              <motion.div 
